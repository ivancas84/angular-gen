...
<app-" . $this->getEntity()->getName("xx-yy") . "-grid [data$]=\"data$\"></app-" . $this->getEntity()->getName("xx-yy") . "-grid>
<app-pagination [display\$]=\"display\$\" [collectionSize\$]=\"collectionSize\$\"></app-pagination>
";
