...
class GenerateComponent {
  ...
  protected function admin($entity){
    require_once("angulariogen/component/admin/AdminTs.php");
    $gen = new ComponentAdminTs($entity);
    $gen->generate();

    require_once("angulariogen/component/admin/AdminHtml.php");
  ...
  protected function fieldset($entity){
    require_once("angulariogen/component/fieldset/FieldsetTs.php");
    $gen = new ComponentFieldsetTs($entity);
    $gen->generate();

    require_once("angulariogen/component/fieldset/FieldsetHtml.php");
  ...
  protected function fieldsetArray($entity){
    require_once("angulariogen/component/fieldsetArray/FieldsetArrayTs.php");
    $gen = new ComponentFieldsetArrayTs($entity);
    $gen->generate();

    require_once("angulariogen/component/fieldsetArray/FieldsetArrayHtml.php");
  ...
  protected function search($entity){
    require_once("angulariogen/component/search/SearchTs.php");
    $gen = new ComponentSearchTs($entity);
    $gen->generate();

    require_once("angulariogen/component/search/SearchHtml.php");
  ...
  protected function show($entity){
    require_once("angulariogen/component/show/ShowTs.php");
    $gen = new ComponentShowTs($entity);
    $gen->generate();

    require_once("angulariogen/component/show/ShowHtml.php");
  ...
  protected function table($entity){
    require_once("angulariogen/component/table/TableTs.php");
    $gen = new ComponentTableTs($entity);
    $gen->generate();

    require_once("angulariogen/component/table/TableHtml.php");
